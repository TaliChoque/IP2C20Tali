...
//parte A: calcular promedio, buscar maximo, buscar minimo

//parte b: calcular los dos elementos que sumados dan 2020.
...
void main (){
    ...
    int max = valores [0]; //en c, javascrip, python, java, arrancan con indice 0
    ...
    //1ER BUCLE
     ...
     for(int x = 0; x < 200; x++){
         primerElemento = valores[x];
            ...
            //primero agarrro el primer elemento de array para ver si que combinacion de dos numeros dan 2020
        ...
        for(int y =0; y < 200; y++){
            ...
            if(suma == 2020){
                ...
                printf("Eureka! %i", primerElemento*valores[y]);
